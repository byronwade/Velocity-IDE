...
pub const commands = [_]CommandItem{
    ...
    .{ .id = "move_line_up", .title = "Move Last Line Up", .hint = "" },
    .{ .id = "move_line_down", .title = "Move Last Line Down", .hint = "" },
    ...
    .{ .id = "indent_document", .title = "Indent Document", .hint = "" },
    .{ .id = "outdent_document", .title = "Outdent Document", .hint = "" },
