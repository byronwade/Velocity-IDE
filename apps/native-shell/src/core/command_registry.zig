...
pub const catalog = [_]Command{
    ...
    .{ .id = "layout_preset_coding", .title = "Layout: Coding Preset" },
    .{ .id = "layout_preset_focus", .title = "Layout: Focus Preset" },
    .{ .id = "layout_preset_review", .title = "Layout: Review Preset" },
    .{ .id = "layout_preset_debug", .title = "Layout: Debug Preset" },
    .{ .id = "layout_preset_terminal", .title = "Layout: Terminal Preset" },
    .{ .id = "save_layout_custom", .title = "Layout: Save Current as Custom" },
    .{ .id = "restore_previous_layout", .title = "Layout: Restore Previous" },
    .{ .id = "reset_layout", .title = "Layout: Reset to Default" },
    ...
    .{ .id = "run_launch_profile", .title = "Run Selected Profile", .feature_id = "feature.terminal-profiles" },
    .{ .id = "refresh_launch_profiles", .title = "Refresh Run Profiles", .feature_id = "feature.terminal-profiles" },
    ...
    .{ .id = "append_snippet", .title = "Append Snippet", .feature_id = "feature.snippets" },
    .{ .id = "reload_snippets", .title = "Reload Snippets", .feature_id = "feature.snippets" },
    .{ .id = "open_scm_diff", .title = "Open SCM Diff", .feature_id = "feature.git-diff" },
