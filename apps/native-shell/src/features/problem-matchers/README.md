...
- Supports TypeScript `path(line,col)`, Zig/GCC/Clang `path:line:col`, and
  Vitest/Jest assertion stack locations while suppressing framework stack noise.
- Includes ANSI stripping, severity/code extraction, deduplication, and a
  64-diagnostic cap.
