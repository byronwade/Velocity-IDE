...
export const OPTIONS: OptionDescriptions<Required<NativeParsedArgs>> = {
	...
	'perf-fork-mode': { type: 'string', cat: 'o', description: localize('perfForkMode', "Performance fork runtime mode: core | developer | compat.") },
	'perf-fork-enable': { type: 'string', cat: 'o', description: localize('perfForkEnable', "Comma-separated performance-fork feature ids to force-enable.") },
	'perf-fork-disable': { type: 'string', cat: 'o', description: localize('perfForkDisable', "Comma-separated performance-fork feature ids to force-disable.") },
