...
/**
 * Lean terminal contribution set for Core Mode.
 * Omits chat/voice/WSL recommendation and other non-essential terminalContrib modules.
 * Full set remains in terminal.all.ts for developer/compat modes.
 */
...
// Essential terminal contributions only
